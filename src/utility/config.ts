...
const config = {
    ...
    JWT_REFRESH_EXPIRES_IN: Number(process.env.JWT_REFRESH_EXPIRES_IN) || 20,
    EMAIL_USER: process.env.EMAIL_USER || "your-email@gmail.com",
    EMAIL_PASS: process.env.EMAIL_PASS || "your-password",
    PASSWORD_RECOVERY_EXPIRATION_MINUTES: Number(process.env.PASSWORD_RECOVERY_EXPIRATION_MINUTES) || 10,
    EMAIL_CONFIRMATION_EXPIRATION_MINUTES: Number(process.env.EMAIL_CONFIRMATION_EXPIRATION_MINUTES) || 10,
